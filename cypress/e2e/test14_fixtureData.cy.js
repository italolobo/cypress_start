...
describe("Fixture test", () => {
    ...
    before(function () { // Usa function() em vez de arrow function
        cy.fixture('example').then((data) => {
            this.data = data; // Agora 'this' se refere ao contexto do Mocha
        });
    });


    it('Using fixture data', function () { // Usa function() em vez de arrow function
        ...
        cy.get('div.suggestions ul li a')
            .contains('India')
            .click();
